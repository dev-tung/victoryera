    ...
    <section class="section section--shadow section--slide section--northern">
        <div class="container">
          <div class="section__header">
            <h2 class="section__title">Northern Tours</h2>
                    ...
                    $northern = new WP_Query(array(
                        ...
                        'tax_query' => array(
                            array(
                                ...
                                'field'    => 'slug',
                                'terms' => 'northern-vietnam'
                            ),
                        ),
                    ));
                ?>

                <?php while ($northern->have_posts()) : $northern->the_post() ?>
