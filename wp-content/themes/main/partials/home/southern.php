    ...
    <section class="section section--shadow section--slide section--southern">
        <div class="container">
          <div class="section__header">
            <h2 class="section__title">Southern Tours</h2>
                    ...
                    $southerns = new WP_Query(array(
                        ...
                        'tax_query' => array(
                            array(
                                ...
                                'field'    => 'slug',
                                'terms' => 'southern-vietnam'
                            ),
                        ),
                    ));
                ?>

                <?php while ($southerns->have_posts()) : $southerns->the_post() ?>
